package component.starling
{
	...
	public class BasicItemRenderer extends FeathersControl implements IListItemRenderer
	{
		...
		protected var itemLabel:feathers.controls.Label;
		...
		override protected function initialize():void
		{
			if(!this.itemLabel)
			{
				this.itemLabel = new feathers.controls.Label();
		...
		protected function autoSizeIfNeeded():Boolean
		{
			...
			var result:Boolean = this.setSizeInternal(newWidth, newHeight, false);
			return false;
		}
